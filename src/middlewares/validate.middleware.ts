...
//what is the purpose of this middleware function?
...
export const validateRequest = (zodSchema: z.ZodObject) => {
	return catchAsync((req: Request, res: Response, next: NextFunction) => {
		...
		if (!result.success) {
			...
			throw new ApiError(httpStatus.BAD_REQUEST, result.error.issues[0]?.message ?? "Validation failed from validateRequest middleware");
		}
