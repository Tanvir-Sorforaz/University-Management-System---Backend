...
router.post("/register", validateRequest(AuthValidation.RegisterStudentZodSchema), AuthController.registerStudent);
...
router.get("/me", auth(Role.STUDENT, Role.FACULTY, Role.ADMIN), AuthController.getMe);
