...
import { EnrollmentStatus, NotificationType, } from "../../../../generated/prisma/enums.js";
 ...
 */
const createEnrollment = async (payload, actor) => {
    ...
    if (semester.department !== studentProfile.department) {
        throw new AppError(httpStatus.BAD_REQUEST, "This semester does not belong to your department");
    }
    ...
    if (!fee || !fee.isPaid) {
        throw new AppError(httpStatus.BAD_REQUEST, "You must pay this semester's fee before enrolling");
    }
