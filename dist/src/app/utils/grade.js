...
export const marksToGrade = (percentage) => {
 ...
 */
export const calculateSemesterGrade = (components) => {
...
export const calculateCgpa = (semesters) => {
    ...
    const totalQualityPoints = semesters.reduce((sum, s) => sum + GRADE_POINTS[s.grade] * s.creditHours, 0);
